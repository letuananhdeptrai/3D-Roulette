...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=367280');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "367280");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "3334173d7984ead0b82db35a2559ac94e05ceabf389e61f10ca29896767cf509");
define('CREATED_TIMESTAMP', "1707472204");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor367280');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor367280');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "roulette.lta-indie.com",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "roulette.lta-indie.com",
));
